    ...
    <div style="min-height: 50px;">
      ...
      top: 0px; left: 0px; width: 1300px; height: 350px; overflow: hidden;">
          ...
          <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1300px; height: 500px; overflow: hidden;">
              <div>
                  <img u="image" src2="../img/slider4.jpg" />
              </div>
              <div>
                  <img u="image" src2="../img/slider5.jpg" />
              </div>
              <div>
                  <img u="image" src2="../img/slider6.jpg" />
              </div>
              <div>
                  <img u="image" src2="../img/slider7.jpg" />
              </div>
              <div>
                  <img u="image" src2="../img/slider8.jpg" />
              </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col ">
          <img src="./img/bannière.jpg" class="img_banniere col-md-offset-3"></img>
       </div>
      </div>
    </div>
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
              <img src="./img/sciences.jpg" class="img_banniere col-md-offset-3"></img>
          </div>
          <div class="col-md-6">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col ">
          <img src="./img/slider3.jpg" class="img_recettes col-md-offset-4"></img>
       </div>
      </div>
    </div>
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
              <img src="./img/calendar.jpg" class="img_calendar col-md-offset-4"></img>
          </div>
          <div class="col-md-6">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col ">
          <img src="./img/blog.jpg" class="img_blog col-md-offset-4"></img>
       </div>
      </div>
    </div>
    ...
    <div class="content">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
              <img src="./img/contact.jpg" class="img_calendar col-md-offset-4"></img>
          </div>
          <div class="col-md-6">
